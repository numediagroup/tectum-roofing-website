...
| # | What it is | Where | What I need from you |
|---|------------|-------|----------------------|
| 29 | **All the page copy is mine** | `contact.html` · throughout | You didn't send copy for this page, so I wrote it: the banner line, the four card notes ("Best for anything urgent", "Send us a photo of the problem", "For quotes, plans and drawings"), and the *Have a Look at What We Do* section. The main form intro is **your** copy, lifted from the homepage contact section. Everything else is a first draft. |
