...
| 6 | **Inner-page nav links** | `index.html` · header | ⚠️ PARTLY RESOLVED — **Domestic Roofing** now has its own page (`domestic-roofing.html`) with a submenu of the 8 services. **"Commercial Roofing"** and **"Inspections & Surveys"** still have no pages and continue to point at the homepage services grid. |
...
| 13 | **Menu labels vs section headings** | header submenu vs section `<h2>`s | Your menu list and your body copy use different names for four services: menu **"Slate Roofs"** → heading **"Slating"**; **"GRP Roofs"** → **"GRP (Fibreglass Roofing)"**; **"Tiled Roofs"** → **"Tiling"**; **"uPVC & Plastic Roofing"** → **"uPVC & Plastics"**. Both are your words so I kept both as written. Say which set you want and I'll make them match. |
...
| 15 | **No quote form on the service page** | `domestic-roofing.html` · CTA band | The page ends with a CTA band (phone, WhatsApp, email + "Request a Quote") that sends people to the homepage form. Tell me if you'd rather the form itself sat on this page too. |
